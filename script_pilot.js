...
var resultExampleNDD = {
    ...
    pages: [
        'content',
        '<div class="instruction"><p>Nun beginnt der eigentlich Versuch. Sie untersuchen dabei mit Unterst&uuml;tzung des automatisierten Scanners 200 weitere Sets auf Dopplungen. Ihr aktueller Punktestand und die vergangene Zeit werden Ihnen nun angezeigt.</p></div>'
    ],
    show_clickable_nav: true,
    button_label_previous: 'Zur&uuml;ck',
    button_label_next: 'Weiter',
