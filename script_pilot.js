...
var instructionMatrixOnly = {
    type: 'instructions',
    pages: [
        '<div class="instruction"><p> In der Spielzeugfabrik "Spielspa&szlig; Speer" werden Bauklötze produziert. Die einzelnen Baukl&ouml;tze werden mit Buchstaben bedruckt und als Set verpackt ausgeliefert. Es gibt drei Setgrößen: 16, 20 und 25 St&uuml;ck.</p> <img src="images/blocks.jpg" alt="Bauklotzset Beispiel" height="200" width="200"> <p>Hierfür stellt eine Maschine aus den bedruckten Baukl&ouml;tzen Sets zusammen, in denen die Baukl&ouml;tze zuf&auml;llig angeordnet sind. </p> <p>Die Maschine achtet darauf, dass <strong>in einem Set jeder Buchstabe nur ein einziges Mal vorkommt</strong>, da es sich andernfalls gem&auml;&szlig; der Vorschriften des Unternehmens um eine Fehllieferung handelt.</p><p> Obwohl die Maschine die Kontrolle übernimmt, kann es trotzdem manchmal zu Fehlern kommen.</p><p>Im Folgenden werden Ihnen solche Sets angezeigt, Ihre Aufgabe ist es, festzustellen, ob eine Dopplung eines Buchstaben vorliegt oder nicht. Arbeiten Sie dabei bitte so genau und schnell wie m&ouml;glich.</p></div>',
...
function chooseResultExampleNDPilot(button) {

    var resMessage

    if (button == 0) {
        resMessage = '<div class="instruction"><p><strong style="color:red";>Falsch!</strong></p><p> In dem Bauklotzset lag kein Buchstabe doppelt vor. Die Antwort <strong>"Set enth&auml;lt keine Dopplung"</strong> war somit <strong style="color:green";>richtig</strong>.</p><p>Es folgt ein weiterer Beispieldurchgang.</p></div>';
    } else {
        resMessage = '<div class="instruction"><p><strong style="color:green";>Richtig!</strong></p><p> In dem Bauklotzset lag kein Buchstabe doppelt vor. Die Antwort <strong>"Set enth&auml;lt keine Dopplung"</strong> war somit <strong style="color:green";>richtig</strong>.</p><p>Es folgt ein weiterer Beispieldurchgang.</p></div>';
    }
...
var exampleMatrixOnlyND = {
    ...
    on_finish: function (data) {
        testTrialFeedback = chooseResultExampleNDPilot(data.button_pressed);
    }
};
...
function chooseResultExampleDPilot(button) {

    var resMessage

    if (button == 0) {
        resMessage = '<div class="instruction"><p><strong style="color:green";>Richtig!</strong></p><p> In dem Bauklotzset lag der Buchstabe "J" doppelt vor. Die Antwort <strong>"Set enth&auml;lt Dopplung"</strong> war somit <strong style="color:green";>richtig</strong>.</p><p> Sie untersuchen nun 30 weitere Sets auf Dopplungen. Arbeiten Sie dabei bitte so genau und schnell wie m&ouml;glich. </p></div>';
    } else {
...
var exampleMatrixOnlyD = {
    ...
    button_html: '<button class="jspsych-btn">%choice%</button>',
    on_finish: function (data) {
        testTrialFeedback = chooseResultExampleDPilot(data.button_pressed);
    }
};
...
var instruction = {
    type: 'instructions',
    pages: [
        '<div class="instruction"><p> Da bei einer Fehllieferung durch den Rückruf des Sets für das Unternehmen großen kosten entstehen, setzt die Spielzeugfabrik "Spielspa&szlig; Speer" zur automatischen &Uuml;berpr&uuml;fung der Bauklotzsets einen  Scanner der Firma <i>BrickScan</i> ein. Dieser &uuml;berpr&uuml;ft die Sets auf m&ouml;gliche Dopplungen. Der Scanner gibt Feedback dar&uuml;ber, ob eine Dopplung in einem Set vorliegt oder nicht.</p> <p>Um die korrekte Funktionsweise des Systems zu gew&auml;hrleisten, werden Sie zus&auml;tzlich als Pr&uuml;fer eingesetzt. Im Folgenden werden Ihnen links auf dem Bildschirm die Bauklotzsets und rechts das Ergebnis des automatisierten Scanners angezeigt. Mithilfe zweier Buttons k&ouml;nnen Sie das Ergebnis des Scanners annehmen, falls Sie es f&uuml;r richtig erachten, oder ablehnen, wenn Sie es f&uuml;r falsch halten.</p></div>',
        '<div class="instruction"><p> Durch die entstehenden Kosten bei Fehllieferungen tragen Sie als Kontrolleur/in eine gro&szlig;e Verantwortung f&uuml;r die Korrektheit der Lieferungen. Ein korrekt ausgeliefertes Set bringt der Firma etwa 25&nbsp;&euro; Gewinn ein. Eine Fehllieferung kostet das Unternehmen durch den Rückruf hingegen 100&nbsp;&euro;. </p><p> Falls Sie eine Fehllieferung erkennen, erhalten Sie einen Bonus von 100 Euro. Allerdings entstehen bei einer falschen Zuordnung durch die unnötige weitere Überprüfung des Sets auch Kosten von 25 Euro. Zudem verlieren Sie durch die Fixkosten für die Produktion mit jeder verstrichenen Minute 10 Euro. Die folgende Tabelle zeigt, wie viele Euro Sie bei Ihren Entscheidungen jeweils gewinnen oder verlieren: </p> <table id="scoring"><tr><th>Aktion</th> <th> Euro </th></tr> <tr> <td> Eine Dopplung korrekt identifizieren </td><td>+100 Euro</td> </tr><tr><td>Eine Dopplung &uuml;bersehen</td> <td> &minus;100 Euro </td></tr> <tr> <td> Ein passendes Set als korrekt einordnen </td><td>+25 Euro</td> </tr><tr><td>Ein passendes Set f&auml;lschlicherweise zur&uuml;ckweisen</td> <td> &minus;25 Euro </td></tr> <tr> <td> Jede vollst&auml;ndig vergangene Minute </td><td>&minus;10 Euro</td> </tr></table> </div>',
        '<div class="instruction">Zun&auml;chst folgen drei Beispieldurchg&auml;nge. W&auml;hrend der Beispieldurchg&auml;nge werden die Zeit und der Punktstand nicht angezeigt.</div>'
    ],
    show_clickable_nav: true,
    button_label_previous: 'Zur&uuml;ck',
    button_label_next: 'Weiter'
...
function chooseResultExampleNDND(button) {

    var resMessage

    if (button == 0) {
        resMessage = '<div class="instruction"><p><strong style="color:green";>Richtig!</strong></p><p> In dem Bauklotzset lag kein Buchstabe doppelt vor. Die Automation hat mitgeteilt, dass keine Dopplung vorliegt. Es war somit <strong style="color:green;">richtig, das Ergebnis der Automation anzunehmen</strong>. </p><p> Die <strong style="color:green;">richtige</strong> Antwort "Ergebnis der Automation annehmen" h&auml;tte 25 Punkte gebracht.</p><p> Die <strong style="color:red;">falsche</strong> Antwort "Ergebnis der Automation ablehnen" h&auml;tte 25 Punkte Abzug bedeutet.</p><p>Es folgt ein weiteres Beispiel.</p></div>';
    } else {
        resMessage = '<div class="instruction"><p><strong style="color:red";>Falsch!</strong></p><p> In dem Bauklotzset lag kein Buchstabe doppelt vor. Die Automation hat mitgeteilt, dass keine Dopplung vorliegt. Es war somit <strong style="color:green;">richtig, das Ergebnis der Automation anzunehmen</strong>. </p><p> Die <strong style="color:green;">richtige</strong> Antwort "Ergebnis der Automation annehmen" h&auml;tte 25 Punkte gebracht.</p><p> Die <strong style="color:red;">falsche</strong> Antwort "Ergebnis der Automation ablehnen" h&auml;tte 25 Punkte Abzug bedeutet.</p><p>Es folgt ein weiteres Beispiel.</p></div>';
    }
...
var exampleNDND = {
    ...
    button_html: '<button class="jspsych-btn">%choice%</button>',
    on_finish: function (data) {
        testTrialFeedback = chooseResultExampleNDND(data.button_pressed);
    }
};
...
function chooseResultExampleDD(button) {

    var resMessage

    if (button == 0) {
        resMessage = '<div class="instruction"><p><strong style="color:green";>Richtig!</strong></p><p> In dem Bauklotzset lag der Buchstabe "N" doppelt vor. Die Automation hat mitgeteilt, dass ein Buchstabe doppelt vorliegt. Es war somit <strong style="color:green;">richtig, das Ergebnis der Automation anzunehmen</strong>. </p><p> Die <strong style="color:green;">richtige</strong> Antwort "Ergebnis der Automation annehmen" h&auml;tte 100 Punkte gebracht.</p><p> Die <strong style="color:red;">falsche</strong> Antwort "Ergebnis der Automation ablehnen" h&auml;tte 100 Punkte Abzug bedeutet.</p><p>Es folgt ein weiteres Beispiel.</p></div>';
    } else {
        resMessage = '<div class="instruction"><p><strong style="color:red";>Falsch!</strong></p><p> In dem Bauklotzset lag der Buchstabe "N" doppelt vor. Die Automation hat mitgeteilt, dass ein Buchstabe doppelt vorliegt. Es war somit <strong style="color:green;">richtig, das Ergebnis der Automation anzunehmen</strong>. </p><p> Die <strong style="color:green;">richtige</strong> Antwort "Ergebnis der Automation annehmen" h&auml;tte 100 Punkte gebracht.</p><p> Die <strong style="color:red;">falsche</strong> Antwort "Ergebnis der Automation ablehnen" h&auml;tte 100 Punkte Abzug bedeutet.</p><p>Es folgt ein weiteres Beispiel.</p></div>';
    }
...
var exampleDD = {
    ...
    button_html: '<button class="jspsych-btn">%choice%</button>',
    on_finish: function (data) {
        testTrialFeedback = chooseResultExampleDD(data.button_pressed);
    }
};
...
function chooseResultExampleNDD(button) {

    var resMessage

    if (button == 0) {
        resMessage = '<div class="instruction"><p><strong style="color:red";>Falsch!</strong></p><p> In dem Bauklotzset lag kein Buchstabe doppelt vor. Die Automation hat jedoch mitgeteilt, dass ein Buchstabe doppelt vorliegt. Es war somit <strong style="color:green;">richtig, das Ergebnis der Automation abzulehnen</strong>.</p><p> Die <strong style="color:green;">richtige</strong> Antwort "Ergebnis der Automation ablehnen" h&auml;tte 25 Punkte gebracht.</p><p> Die <strong style="color:red;">falsche</strong> Antwort "Ergebnis der Automation annehmen" h&auml;tte 25 Punkte Abzug bedeutet.</p></div>';
    } else {
        resMessage = '<div class="instruction"><p><strong style="color:green";>Richtig!</strong></p><p> In dem Bauklotzset lag kein Buchstabe doppelt vor. Die Automation hat jedoch mitgeteilt, dass ein Buchstabe doppelt vorliegt. Es war somit <strong style="color:green;">richtig, das Ergebnis der Automation abzulehnen</strong>.</p><p> Die <strong style="color:green;">richtige</strong> Antwort "Ergebnis der Automation ablehnen" h&auml;tte 25 Punkte gebracht.</p><p> Die <strong style="color:red;">falsche</strong> Antwort "Ergebnis der Automation annehmen" h&auml;tte 25 Punkte Abzug bedeutet.</p></div>';
    }
...
var exampleNDD = {
    ...
    button_html: '<button class="jspsych-btn">%choice%</button>',
    on_finish: function (data) {
        testTrialFeedback = chooseResultExampleNDD(data.button_pressed);
    }
};
...
var resultExampleNDD = {
    ...
    pages: [
        'content',
        '<div class="instruction"><p>Nun beginnt der eigentlich Versuch. Sie untersuchen dabei mit Unterst&uuml;tzung des automatischen Scanners 200 weitere Sets auf Dopplungen. Ihr aktueller Punktestand und die vergangene Zeit werden Ihnen nun angezeigt.</p></div>'
    ],
    show_clickable_nav: true,
    button_label_previous: 'Zur&uuml;ck',
    button_label_next: 'Weiter',
...
var trustcheck = {
    type: 'survey-multi-choice',
    button_label: 'Weiter',
    preamble: '<p> Um zus&auml;tzliche Punkte zu sammeln, k&ouml;nnen Sie den automatischen Scanner 10 zus&auml;tzliche Bauklotzsets bewerten lassen. Dabei arbeitet der Scanner nun ganz eigenst&auml;ndig. Sie k&ouml;nnen sein Ergebnis nicht korrigieren. Bei richtiger Einordnung des Sets durch den Scanner gewinnen Sie wie zuvor Punkte, bei falscher Einordnung verlieren Sie wie gehabt Punkte.',
    questions: [{
