...
var instructionMatrixOnly = {
    type: 'instructions',
    pages: [
        '<div class="instruction"><p> In der Spielzeugfabrik "Spielspa&szlig; Speer" werden Bauklotzsets produziert. Die einzelnen Baukl&ouml;tze werden mit Buchstaben bedruckt.</p> <img src="images/blocks.jpg" alt="Bauklotzset Beispiel" height="200" width="200"> <p>Eine Maschine stellt aus den bedruckten Baukl&ouml;tzen Sets zusammen, in denen die Baukl&ouml;tze zuf&auml;llig angeordnet sind. Es gibt drei Gr&ouml;&szlig;en von Bauklotzsets: 16, 20 und 25 St&uuml;ck.</p> <p>Die Maschine achtet darauf, dass <strong>in einem Set jeder Buchstabe nur maximal einmal vorkommt</strong>, da es sich anderfalls gem&auml;&szlig; der Vorschriften des Unternehmens um eine Fehllieferung handelt.</p><p> Hierbei kann es jedoch manchmal zu Fehlern kommen.</p><p>Im Folgenden werden Ihnen solche Sets angezeigt, Ihre Aufgabe ist es, festzustellen, ob eine Dopplung eines Buchstaben vorliegt oder nicht. Arbeiten Sie dabei bitte so genau und schnell wie m&ouml;glich.</p></div>',
...
var instruction = {
    type: 'instructions',
    pages: [
        '<div class="instruction"><p> Da eine Fehllieferung gro&szlig;e Kosten f&uuml;r das Unternehmen verursacht, setzt die Spielzeugfabrik "Spielspa&szlig; Speer" zur automatischen &Uuml;berpr&uuml;fung der Bauklotzsets einen automatischen Scanner der Firma "BrickScan" ein. Dieser &uuml;berpr&uuml;ft die Sets auf m&ouml;gliche Dopplungen. Der Scanner gibt Feedback dar&uuml;ber, ob eine Dopplung vorliegt oder nicht.</p> <p>Um die korrekte Funktionsweise des Systems zu gew&auml;hrleisten, werden Sie zus&auml;tzlich als Pr&uuml;fer eingesetzt. Im Folgenden werden Ihnen links auf dem Bildschirm die Bauklotzsets und rechts das Ergebnis des automatischen Scanners angezeigt. Mithilfe zweier Buttons k&ouml;nnen Sie das Ergebnis des Scanners annehmen, falls Sie es f&uuml;r richtig erachten, oder ablehnen, wenn Sie es f&uuml;r falsch halten.</p></div>',
        '<div class="instruction"><p>Als Mitarbeiter/in des Unternehmebs tragen Sie gro&szlig;e Verantwortung f&uuml;r die Korrektheit der Lieferungen. Ein Set bringt der Firma etwa 25&nbsp;&euro; ein. Eine Fehllieferung kostet das Unternehmen hingegen 100&nbsp;&euro;. Die Fixkosten belaufen sich auf 10&nbsp;&euro; pro Minute.</p><p> F&uuml;r die korrekte Einteilung der Sets in fehlerhafte mit doppelt vorkommenden Buchstaben und fehlerfreie ohne Dopplung erhalten Sie entsprechend Punkte. F&uuml;r falsche Zuordnungen werden Ihnen jedoch Punkte abgezogen. Zudem verlieren Sie Punkte mit jeder verstrichenen Minute. Die folgende Tabelle zeigt, wie viele Punkte Sie jeweils gewinnen oder verlieren: </p> <table id="scoring"><tr><th>Aktion</th> <th> Punkte </th></tr> <tr> <td> Eine Dopplung korrekt identifizieren </td><td>+100 Punkte</td> </tr><tr><td>Eine Dopplung &uuml;bersehen</td> <td> &minus;100 Punkte </td></tr> <tr> <td> Ein passendes Set als korrekt einordnen </td><td>+25 Punkte</td> </tr><tr><td>Ein passendes Set f&auml;lschlicherweise zur&uuml;ckweisen</td> <td> &minus;25 Punkte </td></tr> <tr> <td> Jede vollst&auml;ndig vergangene Minute </td><td>&minus;10 Punkte</td> </tr></table> </div>',
        '<div class="instruction">Zun&auml;chst folgen drei Beispieldurchg&auml;nge. W&auml;hrend der Beispieldurchg&auml;nge werden Zeit und Punktstand nicht angezeigt.</div>'
    ],
    show_clickable_nav: true,
    button_label_previous: 'Zur&uuml;ck',
    button_label_next: 'Weiter'
